...
var nama = ["budi", "joni", "tejo", "siti"]; // nama.push("ani", "roma");
// console.log(nama.shift())
// nama.unshift("bobi", "robi")
// console.log(nama.slice(0, 5))

var mapel = ["ipa", "bahasa", "matematika"]; // console.log(nama.concat(mapel))
...
nilai.filter(function (a) {
  return a.ipa > 50 && a.matematika > 80 ? console.log(a.nama) : null;
});